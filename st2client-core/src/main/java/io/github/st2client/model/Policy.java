...
/**
 * Represents a StackStorm policy that enforces operational controls on resources such as actions
 * and executions.
 *
 * @author crudb0y69
 * @since 0.1.0
...
public class Policy extends Resource {
   ...
   *
   * @param resourceRef the resource ref to set
   * @since 0.1.0
   */
