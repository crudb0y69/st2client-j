...
/**
 * Represents the schema definition for a StackStorm pack configuration, describing the expected
 * structure and validation rules.
 *
 * @author crudb0y69
 * @since 0.1.0
 */
public class ConfigSchema extends Resource {
  ...
  public boolean equals(Object o) {
    ...
    ConfigSchema other = (ConfigSchema) o;
